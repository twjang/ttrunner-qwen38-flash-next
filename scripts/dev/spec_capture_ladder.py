...
def two_stepn():
    ...
    print(f"RESULT k={K} replayed; replaying k={k2}  <-- the alternation", flush=True)
    b.step_n(toks[10 : 10 + k2])
    print(f"RESULT k={k2} replayed; replaying k={K} again", flush=True)
    a.step_n(toks[10 + k2 : 10 + k2 + K])
