// conv_step_writer.cpp -- the conv's output. The ring shift is the reader's job,
// because it is the core that already holds the old columns in L1.
//
// Compile-time args: TensorAccessorArgs for out
